...
file_to_load = os.path.join("c:/Users/jbate/OneDrive/Desktop/Analysis_Projects/Election_Analysis/Resources/election_results.csv")
...
with open(file_to_save, "w") as txt_file:
    ...
    largest_county_summary = (
       ...
       # f"Winning countyVote Count: {c_winning_count:,}\n"
       # f"Winning County Percentage: {c_winning_percentage:.1f}%\n"
        f"-------------------------\n")
